...
/**
 * Created by Atif Qamar on 30-05-2020.
 */
...
open class RecyclerItemTouchHelper(
    ...
    override fun onMove(
        ...
        Log.i("RecyclerItemTouchHelper", "onMove")
        return true
    }

    override fun onSelectedChanged(viewHolder: RecyclerView.ViewHolder?, actionState: Int) {
        if (viewHolder != null) {
            val foregroundView: ConstraintLayout? =
                (viewHolder as PasswordManagerAdapter.MyViewHolder).viewForeground
